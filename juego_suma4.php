<?php require_once "parte_superior.php"?>
    ...
    <main>
        ...
        <p class="instrucciones_cortas">¿Cuánto es?</p>
            ...
            <div id='lugar_r1'>
                <button class="boton_seleccionable boton_respuesta" name="r_correcta" onclick="mostrar_resultado_respuesta('r1');"  id="r1"  ><img src="imagenes/Numeros/1.png" class="img_boton_respuesta_corta centrar" ></button>
                </div>
                <div id='lugar_r2'>
