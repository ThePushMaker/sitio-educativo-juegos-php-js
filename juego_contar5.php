    ...
    <div class="posicion_btn_volver">
        ...
        <p class="instrucciones_cortas">¿Cuántas princesas hay?</p>
            <div class="grupo_posibles_respuestas centrar">
                <div>
                    <img src="imagenes/princesa/Princesa 9.png" class="img_ejercicio_resolver centrar">
                </div>
            </div>
            <div class="grupo_posibles_respuestas_elegir centrar">
            <div id='lugar_r1'>
                <button class="boton_seleccionable boton_respuesta" name="r_correcta" onclick="mostrar_resultado_respuesta('r1');"  id="r1"  ><img src="imagenes/Numeros/9.png" class="img_boton_respuesta_corta centrar" ></button>
                </div>
                <div id='lugar_r2'>
