<?php require_once "../vistas/parte_superior.php"?>
    ...
    <p class="instrucciones_cortas">Nivel 3 : Ejercicios combinados</p>
        ...
        <p class="instrucciones_cortas">¿Cuál es el numero correcto?</p>
             <div class="grupo_posibles_respuestas img_ejercicio_resolver centrar">
                <div>
                    <img src="../../imagenes/princesa/Princesa 15.png" class=" centrar" id="primero" style="margin-top:20px; width:100%;"> 
                </div>
                <div>
            ...
            <div id='lugar_r1'>
               <button class="boton_seleccionable boton_respuesta" value="r_incorrecta" onclick="mostrar_resultado_respuesta('r1');"  id="r1"  ><img src="../../imagenes/numero_faltante/5.png" class="img_boton_respuesta_corta centrar" id="img_1" ></button>
               </div>
               <div id='lugar_r2'>
                <button class="boton_seleccionable boton_respuesta" value="r_correcta" onclick="mostrar_resultado_respuesta('r2');"  id="r2"  ><img src="../../imagenes/numero_faltante/15.png" class="img_boton_respuesta_corta centrar" id="img_2"></button>
                </div>
                <div id='lugar_r3'>
