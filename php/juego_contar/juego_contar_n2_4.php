<?php require_once "../vistas/parte_superior.php"?>
    ...
    <p class="instrucciones_cortas">Nivel 2 : 4/5 Completar series</p>
        ...
        <p class="instrucciones_cortas">Completa la serie con el numero faltante</p>
            <div class="grupo_posibles_respuestas centrar">
                <div>
                    <img src="../../imagenes/numero_faltante/-4.png" class="img_ejercicio_resolver centrar">
                </div>
            </div>
            ...
            <div id='lugar_r1'>
               ...
               <div id='lugar_r2'>
                ...
                <div id='lugar_r3'>
                <button class="boton_seleccionable boton_respuesta" name="r_correcta" onclick="mostrar_resultado_respuesta('r3');"  id="r3"  ><img src="../../imagenes/numero_faltante/4.png" class="img_boton_respuesta_corta centrar" ></button>
                </div>
            </div>
        </div>
    </main>
    ...
    <script type="text/javascript">
        function llevar_proximo_nvl(){ //
            window.location.href = "../juego_contar/juego_contar_n2_5";
        }
    </script> 
</body>
</html>