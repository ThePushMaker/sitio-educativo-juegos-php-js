<?php require_once "../vistas/parte_superior.php"?>
    ...
    <p class="instrucciones_cortas">Nivel 1 : 1/5 Contar con objetos</p>
        ...
        <p class="instrucciones_cortas">¿Cuántos carros hay?</p>
            <div class="grupo_posibles_respuestas centrar">
                <div>
                    <img src="../../imagenes/carro/Carro 20.png" class="img_ejercicio_resolver centrar">
                </div>
            </div>
            <div class="grupo_posibles_respuestas_elegir centrar">
            <div id='lugar_r1'>
               <button class="boton_seleccionable boton_respuesta" name="r_incorrecta" onclick="mostrar_resultado_respuesta('r1');"  id="r1"  ><img src="../../imagenes/numero_faltante/19.png" class="img_boton_respuesta_corta centrar" ></button>
               </div>
               <div id='lugar_r2'>
                ...
                <div id='lugar_r3'>
                <button class="boton_seleccionable boton_respuesta" name="r_correcta" onclick="mostrar_resultado_respuesta('r3');"  id="r3"  ><img src="../../imagenes/numero_faltante/20.png" class="img_boton_respuesta_corta centrar" ></button>
                </div>
            </div>
        </div>
    </main>
    ...
    <script type="text/javascript">
        function llevar_proximo_nvl(){ //
            window.location.href = "../juego_contar/juego_contar_n1_2";
        }
    </script> 
</body>
</html>