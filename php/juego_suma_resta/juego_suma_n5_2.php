<?php require_once "../vistas/parte_superior.php"?>
    ...
    <main>
        ...
        <p class="instrucciones_cortas">¿Cuánto es?</p>
            ...
            <div id='lugar_r1'>
                <button class="boton_seleccionable boton_respuesta" name="r_correcta" onclick="mostrar_resultado_respuesta('r1');"  id="r1"  ><img src="../../imagenes/Numeros/4.png" class="img_boton_respuesta_corta centrar" ></button>
                </div>
                <div id='lugar_r2'>
    ...
    <script type="text/javascript">
        function llevar_proximo_nvl(){ //
            window.location.href = "../juego_suma_resta/juego_suma_n5_3";
        }
    </script> 
</body>
</html>