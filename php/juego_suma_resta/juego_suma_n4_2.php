<?php require_once "../vistas/parte_superior.php"?>
    ...
    <main>
        ...
        <p class="instrucciones_cortas">Nivel 4 : 2/5 Resta con numeros</p>
        ...
        <p class="instrucciones_cortas">¿Cuánto es?</p>
            <div class="grupo_posibles_respuestas img_ejercicio_resolver centrar">
                <div>
                    <img src="../../imagenes/Numeros/9.png" class="centrar"  style="margin-top:20px; width:100%;">
                </div>
                <div>
            ...
            <div id='lugar_r1'>
                <button class="boton_seleccionable boton_respuesta" name="r_correcta" onclick="mostrar_resultado_respuesta('r1');"  id="r1"  ><img src="../../imagenes/Numeros/8.png" class="img_boton_respuesta_corta centrar" ></button>
                </div>
                <div id='lugar_r2'>
    ...
    <script type="text/javascript">
        function llevar_proximo_nvl(){ //
            window.location.href = "../juego_suma_resta/juego_suma_n4_3";
        }
    </script> 
</body>
</html>