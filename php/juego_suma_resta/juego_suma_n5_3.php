<?php require_once "../vistas/parte_superior.php"?>
    ...
    <main>
        ...
        <p class="instrucciones_cortas">Nivel 5 : 3/5 Ejercicios combinados</p>
        ...
        <p class="instrucciones_cortas">¿Cuánto es?</p>
            <div class="grupo_posibles_respuestas img_ejercicio_resolver centrar">
                <div>
                    <img src="../../imagenes/caballero/Caballero 4.png" class="centrar"  style="margin-top:20px; width:100%;">
                </div>
                <div>
            ...
            <div id='lugar_r1'>
                ...
                <div id='lugar_r2'>
                <button class="boton_seleccionable boton_respuesta" name="r_incorrecta"  onclick="mostrar_resultado_respuesta('r2');"  id="r2"> <img src="../../imagenes/Numeros/2.png" class="img_boton_respuesta_corta centrar" ></button>
                </div>
                <div id='lugar_r3'>
                <button class="boton_seleccionable boton_respuesta" name="r_incorrecta"  onclick="mostrar_resultado_respuesta('r3');"  id="r3"> <img src="../../imagenes/Numeros/5.png" class="img_boton_respuesta_corta centrar" ></button>
                </div>
            </div>
        </div>
    </main>
    ...
    <script type="text/javascript">
        function llevar_proximo_nvl(){ //
            window.location.href = "../juego_suma_resta/juego_suma_n5_4";
        }
    </script> 
</body>
</html>