<?php require_once "../vistas/parte_superior.php"?>
    ...
    <main>
        ...
        <p class="instrucciones_cortas">Nivel 3 : 2/5 Resta con objetos</p>
        ...
        <p class="instrucciones_cortas">¿Cuánto es?</p>
            <div class="grupo_posibles_respuestas img_ejercicio_resolver centrar">
                <div>
                    <img src="../../imagenes/princesa/Princesa 9.png" class="centrar"  style="margin-top:20px; width:100%;">
                </div>
                <div>
    ...
    <script type="text/javascript">
        function llevar_proximo_nvl(){ //
            window.location.href = "../juego_suma_resta/juego_suma_n3_3";
        }
    </script> 
</body>
</html>