<?php require_once "../vistas/parte_superior.php"?>
    ...
    <main>
        ...
        <div class="recuadro_blanco_fondo centrar">
            ...
            <p class="ref_video">Referencia: Happy Learning Español. (16 de octubre de 2018). Aprendiendo a restar La Resta | Vídeos Educativos para niños [Archivo de video]. Youtube. https://www.youtube.com/watch?v=42vjqtleG9E&t</p>
        </div>
    </main>
</body>
</html>