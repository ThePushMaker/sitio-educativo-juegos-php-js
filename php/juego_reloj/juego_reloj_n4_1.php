...
<main>
    ...
    <p class="instrucciones_cortas">Nivel 4 : Identificar manecillas</p>
...
<script type="text/javascript">
    ...
    localStorage.setItem("archivo_niveles_ruta", "../juego_reloj/niveles4.json");

    function llevar_proximo_nvl() { //
        window.location.href = "../juego_reloj/juego_reloj_n5_1";
    }
    desbloquear_nivel(1,"juego_reloj_n4");
</script>
