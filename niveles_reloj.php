<?php require_once "parte_superior.php"?>
    ...
    <div class="posicion_btn_volver">
        ...
        <div class="recuadro_blanco_fondo centrar">
            ...
            <a href="video_reloj.php" class="btn_nivel boton_seleccionable_video">
            ...
            <a href="juego_reloj_n1_1.php" class="btn_nivel boton_seleccionable">
            ...
            <a href="juego_reloj_n2_1.php" class="btn_nivel boton_seleccionable">
            ...
            <a href="juego_reloj_n3_1.php" class="btn_nivel boton_seleccionable">
                <h2>  
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-clock" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    <circle cx="12" cy="12" r="9" />
            ...
            <a href="juego_reloj_n4_1.php" class="btn_nivel boton_seleccionable">
                <h2>  
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-clock " width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                <circle cx="12" cy="12" r="9" />
            ...
            <a href="juego_reloj_n5_1.php" class="btn_nivel boton_seleccionable">
                <h2>  
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-clock " width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                <circle cx="12" cy="12" r="9" />
