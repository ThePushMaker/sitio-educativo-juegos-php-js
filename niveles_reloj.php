<?php require_once "parte_superior.php"?>
    ...
    <div class="posicion_btn_volver">
        ...
        <div class="recuadro_blanco_fondo centrar">
            ...
            <a href="juego_reloj.php" class="btn_nivel boton_seleccionable">
                <h2>Nivel 1</h2>
            </a>

            <a href="juego_reloj2.php" class="btn_nivel boton_seleccionable">
                <h2>Nivel 2</h2>
            </a>
            <a href="juego_reloj3.php" class="btn_nivel boton_seleccionable">
                <h2>Nivel 3</h2>
            </a>
            <a href="juego_reloj4.php" class="btn_nivel boton_seleccionable">
                <h2>Nivel 4</h2>
            </a>
            <a href="juego_reloj5.php" class="btn_nivel boton_seleccionable">
                <h2>Nivel 5</h2>
            </a>
